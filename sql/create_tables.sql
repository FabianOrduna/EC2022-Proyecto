CREATE TABLE IF NOT EXISTS house (
  id serial PRIMARY KEY,
    ...
    mainroad varchar(250) NOT NULL,
    guestroom varchar(250) NOT NULL,
    basement varchar(250) NOT NULL,
    hotwaterheating varchar(250) NOT NULL,
    airconditioning varchar(250) NOT NULL,
    parking INT NOT NULL,
    prefarea varchar(250) NOT NULL,
    furnishingstatus varchar(250) NOT NULL
);



INSERT INTO house (price,area,bedrooms,bathrooms,stories,mainroad,guestroom,basement,hotwaterheating,airconditioning,parking,prefarea,furnishingstatus)
VALUES 
